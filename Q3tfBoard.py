...
def cnn_model_fn(features, labels, mode,params):
    ...
    # Configure the Training Op (for TRAIN mode)
        ...
        #     custom_metric = tf.metrics.accuracy(labels=labels, predictions=predictions)
        #     # Returning as a dict:
        #     return {"custom_metric": custom_metric}
        #
        # estimatorSpec = tf.contrib.estimator.add_metrics(estimatorSpec, custom_metric)
...
def main(unused_argv):
    ...
    mnist_classifier = tf.estimator.Estimator(model_fn=cnn_model_fn,  params=params,
                                              ...
                                              model_dir='/tmp/mnist_network/Q3_c'
    ...
    print(eval_results)
    # writer = tf.summary.FileWriter("/tme/mnist_network/Q3")
    # writer.add_graph(sess.gra[h])
