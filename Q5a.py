...
# Train a CNN network on MNIST  with normalize and dropout + validation set and early stopping + reduce Learning rate every 400 iterations
...
def main(model_dir='/tmp/mnist_networks/Q5a'):
    params = {
        # Q1b
        'batch_size': 100,
        # Q1c
